#!/usr/bin/env python3
"""
Garmin Connect Client and Formatter Classes

This module provides classes for interacting with Garmin Connect API
and formatting activity data for display.
"""
